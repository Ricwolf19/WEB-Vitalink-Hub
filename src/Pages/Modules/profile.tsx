...
import { ProfileInfoCard, MessageCard } from "../../Components/Dashboard/Cards";
            ...
            <div className="w-96">
              <Tabs value="app">
                <TabsHeader placeholder="">
                  ...
                  <Tab placeholder="" value="message">
                    <ChatBubbleLeftEllipsisIcon className="-mt-0.5 mr-2 inline-block h-5 w-5" />
                    Message
                  </Tab>
                  <Tab placeholder="" value="settings">
            ...
            <div>
              ...
              <div className="flex flex-col gap-12">
                {platformSettingsData.map(({ title, options }) => (
                  <div key={title}>
                    <Typography placeholder="" className="mb-4 block text-xs font-semibold uppercase text-blue-gray-500">
                      {title}
                    </Typography>
            ...
            <div className="mt-6 grid grid-cols-1 gap-12 md:grid-cols-2 xl:grid-cols-4">
              {projectsData.map(
                ({ img, title, description, tag, route, members }) => (
                  <Card placeholder="" key={title} color="transparent" shadow={false}>
                    <CardHeader
                    placeholder=""
                      floated={false}
                      color="gray"
